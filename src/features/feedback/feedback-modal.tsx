...
export function FeedbackModal({ diagnosticId }: { diagnosticId: string }) {
  ...
  if (state === "closed") return <button type="button" onClick={() => setState("form")} className="mt-3 inline-flex items-center justify-center text-center font-medium text-muted underline underline-offset-4 hover:text-brand focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand">Оценить аудит</button>;
