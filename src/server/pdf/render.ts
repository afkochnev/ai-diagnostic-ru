...
export async function renderPdf(input: PdfInput): Promise<Buffer> {
  ...
  try {
    const rendering = (async () => {
      ...
      return page.pdf({ format: "A4", printBackground: true, preferCSSPageSize: true, displayHeaderFooter: true, headerTemplate: "<span></span>", footerTemplate: '<div style="width:100%;font-family:Arial, sans-serif;font-size:8px;color:#8295a0;text-align:right;padding:0 17mm;"> <span class="pageNumber"></span> / <span class="totalPages"></span></div>' });
    })();
